    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="px-4 py-4 max-w-lg mx-auto space-y-4">
        <div className="bg-slate-800 rounded-xl p-5">
          <h2 className="font-bold text-white text-base mb-3">שיטת ריצה-הליכה</h2>
        ...
        <div className="bg-slate-800 rounded-xl p-5">
          ...
          <div className="space-y-2">
            {[
              ...
              { day: 'שישי', type: 'מנוחה (תמיד)', color: 'bg-slate-700 text-slate-400 border border-slate-600' },
            ].map(({ day, type, color }) => (
              <div key={day} className="flex items-center gap-3">
                <span className="text-sm font-medium text-slate-400 w-16">{day}</span>
        ...
        <div className="bg-slate-800 rounded-xl p-5">
          <h2 className="font-bold text-white text-base mb-3">מטרות לפי חודש</h2>
        ...
        <div className="bg-slate-800 rounded-xl p-5">
          <h2 className="font-bold text-white text-base mb-3">מושגי יסוד</h2>
          <div className="space-y-3">
            {[
              ...
              <div key={term}>
                <p className="font-semibold text-sm text-white">{term}</p>
                <p className="text-sm text-slate-400 leading-6">{def}</p>
              </div>
            ))}
          </div>
        </div>
